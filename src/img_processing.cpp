...
namespace proc
{
    ...
    {
        static cv::Mat filter = (cv::Mat_<double>(3, 3) << -1.0F, -1.0F,
                                 -1.0F, -1.0F, 9.0F,
                                 -1.0F, -1.0F, -1.0F, -1.0F);
        if (para) {
            return apply_filter_para(filter, img);
    ...
    {
        static cv::Mat filter = (cv::Mat_<double>(3, 3) << -0.5F, -0.5F,
                                 -0.5F, -0.5F, 4.0F,
                                 -0.5F, -0.5F, -0.5F, -0.5F);
        if (para) {
            return apply_filter_para(filter, img);
    ...
    {
        static cv::Mat filter = (cv::Mat_<double>(3, 3) << 0.1F, 0.1F,
                                 0.1F, 0.1F, 1.0F,
                                 0.1F, 0.1F, 0.1F, 0.1F);
        if (para) {
            return apply_filter_para(filter, img);
    ...
    {
        static cv::Mat filter = (cv::Mat_<double>(3, 3) << 0.01F, 0.01F,
                                 0.01F, 0.01F, 0.5F,
